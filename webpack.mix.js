...
mix.babel('node_modules/izitoast/dist/js/iziToast.min.js',
 ...
 mix.js('resources/assets/js/challenges/challenges.js', 'public/assets/js/challenges/challenges.js').version();


 mix.js('resources/assets/js/flexers/flexers.js', 'public/assets/js/flexers/flexers.js').version();


 mix.js('resources/assets/js/kingdoms/kingdoms.js', 'public/assets/js/kingdoms/kingdoms.js').version();


 mix.js('resources/assets/js/lands/lands.js', 'public/assets/js/lands/lands.js').version();


 mix.js('resources/assets/js/users/users.js', 'public/assets/js/users/users.js').version();


 mix.js('resources/assets/js/weeks/weeks.js', 'public/assets/js/weeks/weeks.js').version();
